...
export const products: ProductModel[] = [
...

  {
    ...
    description:
      'The FilmRaid-8 is a high-capacity 8-bay professional RAID tower engineered for demanding film and broadcast workflows. With up to 192TB of raw storage, sustained speeds of up to 2600MB/s, and support for DisplayPort 1.4 (8K at 30Hz), it handles the most data-intensive productions without compromise. Built on an Areca RAID controller with a dual-core processor and 2GB DDR3 ECC memory, it supports the full range of RAID levels including 0, 5, 6, 10, and JBOD. Available with Toshiba MG09SCA (18TB), Toshiba MG10SCA (20TB), Toshiba MG10SFA (22TB), or Seagate Exos X24 (24TB) enterprise SAS drives. Pre-installed and pre-configured, ready to use the moment it arrives. Ideal for DITs managing large shooting days, editors working with 6K and 8K footage, and post houses that need reliable high-volume storage. Delivered across Europe via FedEx from Barcelona. 3-year warranty included.',
    specs: [
