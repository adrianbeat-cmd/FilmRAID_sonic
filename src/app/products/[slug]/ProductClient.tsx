...
const ProductClient = ({
  ...
  const onSubmit: SubmitHandler<OrderFormData> = async (data) => {
    try {
      ...
      setSubmitNotice({ type: 'success', msg: 'Request sent! Please check your inbox.' });
      ...
      <div className="container grid grid-cols-1 gap-8 md:grid-cols-2 md:items-start">
        ...
        <div className="order-2 space-y-4 md:col-start-2 md:row-start-1">
          ...
          <div>
            ...
            <p className="text-sm">{tb}TB per drive</p>
            <p className="text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <Dialog>
                <DialogTrigger asChild>
                  <button
                    type="button"
                    className="text-primary hover:bg-primary hover:text-primary-foreground flex h-5 w-5 items-center justify-center rounded-full border border-current text-xs font-bold transition-colors"
