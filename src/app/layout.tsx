...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Pre-configured Areca RAID systems with enterprise SAS drives. 72TB to 288TB, ready to use, shipped across Europe in 3 days. Built for DITs and post-production professionals.',
    siteName: 'FilmRAID',
    type: 'website',
  ...
  (function () {
    try {
      ...
      addEventListener('DOMContentLoaded', install);
        ...
        <Script src="/tax-label-fallback.js?v=20250826-29" strategy="afterInteractive" />
